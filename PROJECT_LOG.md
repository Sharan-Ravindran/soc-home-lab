...
- finished a python script to do log parsing of all the alerts generated by the wazuh server
- synced the python script to the main pipeline and configured it to automatically filter incoming alerts from wazuh
- 
