...
Custom visualizations were created for:

Attack Types

Shows the number of detected SQL injection and XSS alerts.

Attack Timeline

Shows when suspicious events occurred.

Source IPs

Shows which source IP generated the detected web attack traffic.
...
INCIDENT SUMMARY
--------------------------------
Source IP(s) : 192.168.251.128
Attack types : SQL Injection, XSS
Alert count  : 2
Max severity : 10
